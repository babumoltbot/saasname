...
- OG image dynamically generated via `src/app/opengraph-image.tsx` (no static file)
...
- OG image now dynamically generated by `src/app/opengraph-image.tsx` (static `og-image.png` removed)
